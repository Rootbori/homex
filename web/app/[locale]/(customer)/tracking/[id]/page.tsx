...
export default async function TrackingPage({
  ...
  const [job, locale] = await Promise.all([getUserJob(id), getPreferredLocale()]);
    ...
    <div className="mx-auto max-w-3xl">
      ...
      <header className="sticky top-0 z-50 border-b border-black/[0.04] bg-white/80 backdrop-blur-xl">
        <div className="flex h-14 items-center gap-3 px-4">
          <Link href={localizeAppPath("/my-requests", locale)} className="text-on-surface-variant/50 hover:text-on-surface">
