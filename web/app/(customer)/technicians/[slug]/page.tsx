    ...
    <div>
      ...
      <main className="page-content page-stack-lg">
        ...
        <section className="grid grid-cols-3 gap-3">
          ...
          <button className="flex flex-col items-center justify-center gap-2 rounded-[1.5rem] bg-surface-container-low px-3 py-4 transition-colors duration-200 active:scale-95">
        ...
        <section className="surface-card rounded-[1.75rem] p-5 ambient-shadow md:p-6">
          <div className="section-stack">
            <h2 className="headline-font text-lg font-bold">เกี่ยวกับช่าง</h2>
        ...
        <section className="surface-card rounded-[1.75rem] p-5 ambient-shadow md:p-6">
          <div className="section-stack">
            <h2 className="headline-font text-lg font-bold">บริการและราคา</h2>
            <div className="card-stack">
              {technician.services.map((service, index) => (
                <div
                  key={service}
                  className="flex items-center justify-between rounded-[1.5rem] bg-surface-container-lowest p-5"
                >
                  <div>
        ...
        <section className="surface-card rounded-[1.75rem] p-5 ambient-shadow md:p-6">
          <div className="section-stack">
            <h2 className="headline-font text-lg font-bold">พื้นที่ให้บริการ</h2>
        ...
        <section className="surface-card rounded-[1.75rem] p-5 ambient-shadow md:p-6">
          <div className="section-stack">
            <h2 className="headline-font text-lg font-bold">ผลงานที่ผ่านมา</h2>
